...
// en el root [locale]/layout.tsx, que además ya monta el NextIntlClientProvider compartido por
// (site) y (demos)). Vive en el grupo (site) para NO envolver a las demos, que tienen su propio
// chrome en (demos). El <html>/<body> es compartido con (demos) → soft-nav site↔demo.
