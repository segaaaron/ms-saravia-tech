 ...
 * UI de marca con recuperación (reintentar / recargar) en vez de la pantalla negra
 * "Application error" de Next. El caso apex→www que la motivó se resuelve ahora en el edge
 * (Traefik), así que esto queda como red de seguridad genérica.
 */
