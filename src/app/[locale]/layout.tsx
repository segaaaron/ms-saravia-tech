  ...
  return (
    <html lang={locale} className={`${spaceGrotesk.variable} ${inter.variable}`}>
      <body suppressHydrationWarning>
        {/*
          Host canónico apex→www: se resuelve en el edge (Traefik, redirect 308 antes de
          Next — ver /etc/dokploy/traefik/dynamic/zz-apex-redirect.yml en el VPS). El apex
          nunca sirve documento, así que ningún <Link> puede disparar un fetch RSC
          cross-origin. El middleware Next mantiene el guard como defensa en profundidad.
        */}
