...
const posts: Post[] = [
  {
    ...
    en: {
      ...
      body: [
        { type: 'p', text: 'Canadian companies building software face a specific squeeze: local senior engineering salaries in Toronto, Vancouver and Montreal rival the US, the talent market is tight, and privacy rules add their own weight. That makes "how do we staff this?" a sharper question than it looks.' },
        { type: 'h2', text: 'The local-hire reality' },
        { type: 'p', text: 'A senior developer in a major Canadian hub is a six-figure CAD commitment before benefits, and the competition for that person is fierce. For a well-funded product team it is worth it. For a first build, an MVP, or extra capacity on a roadmap, paying full local rates for permanence you do not yet need is where budgets quietly disappear.' },
        { type: 'h2', text: 'Where nearshore fits for Canada' },
        { type: 'ul', items: [
          'Timezone: Latin America overlaps the Canadian workday coast to coast — no overnight handoffs.',
          'Cost: typically 40-60% below Toronto/Vancouver senior rates, in USD-denominated contracts.',
          'English-fluent, senior talent used to working with North American teams and process.',
          'A US-registered entity means clean contracting and NDAs without offshore friction.',
        ] },
        { type: 'h2', text: 'Do not forget PIPEDA' },
        { type: 'p', text: 'Canadian privacy law (PIPEDA, and Quebec’s Law 25) governs how personal data is collected, stored and transferred — including across borders. Wherever your team sits, the architecture has to handle consent, data residency where required, and clear processing terms. A team that has shipped for regulated North American products designs for this from the start rather than retrofitting it after an audit.' },
        { type: 'h2', text: 'The pragmatic answer' },
        { type: 'p', text: 'Hire locally for the core team you intend to keep for years; use a senior nearshore team for capacity, speed and cost-sensitive builds — with the same timezone and contract standards you would expect at home. See our nearshore page for how the timezone, billing and privacy pieces fit together, or price your build with the estimator.' },
      ],
    },
    es: {
      title: 'Contratar un Equipo de Software en Canadá: ¿Local, Nearshore u Offshore?',
      excerpt: 'Los salarios tech canadienses, PIPEDA y un mercado de talento apretado moldean la decisión de construir o tercerizar. Cómo comparan las opciones en CAD.',
      body: [
        { type: 'p', text: 'Las empresas canadienses que construyen software enfrentan una presión específica: los salarios de ingeniería senior en Toronto, Vancouver y Montreal rivalizan con los de USA, el mercado de talento está apretado, y las reglas de privacidad suman su propio peso. Eso vuelve la pregunta "¿cómo dotamos esto de personal?" más aguda de lo que parece.' },
        { type: 'h2', text: 'La realidad de contratar local' },
        { type: 'p', text: 'Un developer senior en un hub canadiense grande es un compromiso de seis cifras en CAD antes de beneficios, y la competencia por esa persona es feroz. Para un equipo de producto bien financiado, vale la pena. Para un primer build, un MVP, o capacidad extra en un roadmap, pagar tarifas locales completas por una permanencia que aún no necesitas es donde los presupuestos desaparecen en silencio.' },
        { type: 'h2', text: 'Dónde encaja nearshore para Canadá' },
        { type: 'ul', items: [
          'Zona horaria: Latinoamérica solapa la jornada canadiense de costa a costa — sin entregas de un día para otro.',
          'Costo: normalmente 40-60% por debajo de tarifas senior de Toronto/Vancouver, en contratos en USD.',
          'Talento senior con inglés fluido, acostumbrado a trabajar con equipos y procesos norteamericanos.',
          'Una entidad registrada en USA significa contratación limpia y NDAs sin fricción de offshore.',
        ] },
        { type: 'h2', text: 'No olvides PIPEDA' },
        { type: 'p', text: 'La ley de privacidad canadiense (PIPEDA, y la Ley 25 de Quebec) rige cómo se recolectan, almacenan y transfieren los datos personales — incluso a través de fronteras. Sin importar dónde esté tu equipo, la arquitectura debe manejar consentimiento, residencia de datos donde se requiera, y términos de procesamiento claros. Un equipo que ha entregado para productos norteamericanos regulados diseña para esto desde el inicio en vez de adaptarlo tras una auditoría.' },
        { type: 'h2', text: 'La respuesta pragmática' },
        { type: 'p', text: 'Contrata local para el equipo central que piensas mantener por años; usa un equipo nearshore senior para capacidad, velocidad y builds sensibles al costo — con el mismo horario y estándares de contrato que esperarías en casa. Mira nuestra página de nearshore para ver cómo encajan la zona horaria, la facturación y la privacidad, o cotiza tu build con el estimador.' },
      ],
    },
  },
  {
    ...
    en: {
      ...
      body: [
        { type: 'p', text: 'Latin America has quietly become one of the strongest regions in the world for software talent — senior engineers, modern stacks, and a working culture aligned with North America. Whether you are a US/Canadian company hiring nearshore or a LATAM founder choosing a local partner, the same question applies: how do you pick an agency that actually delivers?' },
        { type: 'h2', text: 'Why LATAM, specifically' },
        { type: 'p', text: 'The region combines three things that rarely coexist: deep senior talent, timezone alignment with North America, and rates well below US/Canada. A strong LATAM team gives you same-workday collaboration and modern engineering (Next.js, React Native, cloud, AI) without the offshore coordination tax or the local price tag.' },
        { type: 'h2', text: 'What separates a real agency from a body shop' },
        { type: 'ul', items: [
          'Senior engineers on YOUR project — not a sales lead who hands off to juniors after signing.',
          'A defined process: sprints, code review, QA and clear communication in English and Spanish.',
          'Live work you can click and references you can call, not just portfolio screenshots.',
          'Clear terms on code ownership, IP and source-control access from day one.',
          'For cross-border work: a US-registered entity so US/Canadian clients sign standard contracts and NDAs.',
        ] },
        { type: 'h2', text: 'What it should cost' },
        { type: 'p', text: 'LATAM senior rates typically land 40-60% below comparable US/Canada agencies — but "cheapest" is a trap. The gap between a $25/hr ticket-churner and a senior-led team is measured in rework, missed deadlines and rebuilds, not in the invoice. Price on outcomes and seniority, not the hourly headline.' },
        { type: 'h2', text: 'How we work' },
        { type: 'p', text: 'We are a US-registered LLC with a senior-led Latin American team — nearshore for US/Canada, local-standard for LATAM founders. You get modern engineering, same-timezone collaboration and contracts you can trust. Start with a scoped estimate and prove it on a first milestone before committing further.' },
      ],
    },
    es: {
      title: 'Agencias de Desarrollo de Software en Latinoamérica: Guía para Contratar',
      excerpt: 'Latinoamérica se volvió un hub serio de talento senior en software. Qué buscar, cuánto pagar, y cómo contratar una agencia LATAM que sí entrega.',
      body: [
        { type: 'p', text: 'Latinoamérica se volvió en silencio una de las regiones más fuertes del mundo en talento de software — ingenieros senior, stacks modernos, y una cultura de trabajo alineada con Norteamérica. Seas una empresa de USA/Canadá contratando nearshore o un fundador LATAM eligiendo un socio local, aplica la misma pregunta: ¿cómo eliges una agencia que de verdad entrega?' },
        { type: 'h2', text: 'Por qué LATAM, específicamente' },
        { type: 'p', text: 'La región combina tres cosas que rara vez coexisten: talento senior profundo, alineación horaria con Norteamérica, y tarifas muy por debajo de USA/Canadá. Un equipo LATAM fuerte te da colaboración en la misma jornada e ingeniería moderna (Next.js, React Native, cloud, IA) sin el impuesto de coordinación del offshore ni el precio local del norte.' },
        { type: 'h2', text: 'Qué separa una agencia real de un "body shop"' },
        { type: 'ul', items: [
          'Ingenieros senior en TU proyecto — no un líder de ventas que te pasa a juniors después de firmar.',
          'Un proceso definido: sprints, code review, QA y comunicación clara en inglés y español.',
          'Trabajo en vivo que puedes clickear y referencias a las que puedes llamar, no solo capturas de portafolio.',
          'Términos claros sobre propiedad del código, IP y acceso al control de versiones desde el día uno.',
          'Para trabajo transfronterizo: una entidad registrada en USA para que clientes de USA/Canadá firmen contratos y NDAs estándar.',
        ] },
        { type: 'h2', text: 'Cuánto debería costar' },
        { type: 'p', text: 'Las tarifas senior en LATAM suelen quedar 40-60% por debajo de agencias comparables de USA/Canadá — pero "el más barato" es una trampa. La diferencia entre un despachador de tickets de $25/hr y un equipo liderado por seniors se mide en retrabajo, plazos incumplidos y reconstrucciones, no en la factura. Cotiza por resultados y seniority, no por el titular de la tarifa por hora.' },
        { type: 'h2', text: 'Cómo trabajamos' },
        { type: 'p', text: 'Somos una LLC registrada en USA con un equipo latinoamericano liderado por seniors — nearshore para USA/Canadá, estándar local para fundadores LATAM. Obtienes ingeniería moderna, colaboración en la misma zona horaria y contratos en los que puedes confiar. Arranca con una estimación acotada y pruébala en un primer hito antes de comprometerte más.' },
      ],
    },
  },
  {
    ...
    en: {
      ...
      body: [
        ...
        { type: 'p', text: 'Pick in-house when the product IS the company and you are funded to own a permanent team. Pick offshore when scope is rigid, well-documented and communication-light. Pick nearshore when you want senior quality and US-timezone collaboration without US-agency pricing — which describes most startups and mid-market builds. That last model is exactly how we work; see our nearshore page for how the timezone, contracts and billing actually fit together.' },
      ],
    },
    es: {
      title: 'Nearshore vs Offshore vs Equipo Interno: ¿Qué Modelo Gana?',
      excerpt: 'Zona horaria, costo, calidad y control tiran en direcciones distintas. Una comparación clara de las tres formas de construir software — y cuándo conviene cada una.',
      body: [
        { type: 'p', text: 'Todo fundador que construye software enfrenta la misma decisión de tres vías: equipo interno, mandarlo offshore, o ir nearshore. El marketing de cada opción grita fuerte; los trade-offs no. Esta es la versión honesta — qué ganas y qué cedes con cada modelo.' },
        { type: 'h2', text: 'Interno: control máximo, costo máximo' },
        { type: 'p', text: 'Un equipo full-time en USA o Canadá te da el control más estrecho, contexto compartido y cero brecha horaria. También es el camino más caro por mucho, el más lento de armar y el más difícil de escalar hacia arriba o abajo. Para una empresa financiada construyendo su producto central a largo plazo, suele ser lo correcto. Para un build temprano o un proyecto de alcance fijo, pagas un premium por una permanencia que aún no necesitas.' },
        { type: 'h2', text: 'Offshore: la tarifa más barata, el impuesto de coordinación más alto' },
        { type: 'p', text: 'Offshore (típicamente Asia o Europa del Este desde la óptica de USA) gana en tarifa por hora. El costo escondido es la coordinación: una brecha de 8-12 horas convierte una pregunta rápida en un ida y vuelta de 24 horas, y la distancia cultural o de idioma aparece como retrabajo. Funciona bien para flujos independientes y bien especificados — y mal para producto ambiguo que se mueve rápido y necesita ida y vuelta constante.' },
        { type: 'h2', text: 'Nearshore: el medio que suele ser el punto ideal' },
        { type: 'ul', items: [
          'Solape horario: Latinoamérica comparte casi toda la jornada de USA/Canadá — dailies en tiempo real, respuestas el mismo día.',
          'Costo: normalmente 40-60% por debajo de tarifas de USA/Canadá, sin el impuesto de coordinación del offshore.',
          'Seniority y comunicación: talento senior fuerte que trabaja como los equipos de USA esperan.',
          'Contratos: con una entidad registrada en USA firmas términos estándar de USA y un NDA — sin fricción transfronteriza.',
        ] },
        { type: 'h2', text: 'Cómo elegir de verdad' },
        { type: 'p', text: 'Elige interno cuando el producto ES la empresa y estás financiado para tener un equipo permanente. Elige offshore cuando el alcance es rígido, documentado y de poca comunicación. Elige nearshore cuando quieres calidad senior y colaboración en horario de USA sin precio de agencia de USA — que describe a la mayoría de startups y builds de mercado medio. Ese último modelo es justo cómo trabajamos; mira nuestra página de nearshore para ver cómo encajan la zona horaria, los contratos y la facturación.' },
      ],
    },
  },
  {
    slug: 'how-to-vet-software-agency',
    date: '2026-07-31',
    cluster: 'tech-consulting',
    en: {
      title: 'How to Vet a Software Development Agency Before You Sign',
      excerpt: 'A polished website is not evidence. The questions, red flags and proof that separate an agency that ships from one that sells.',
      body: [
        { type: 'p', text: 'Choosing a development agency is a high-stakes, low-information decision: you are betting your budget and timeline on a team you have known for two calls. Every agency claims "senior engineers" and "on-time delivery." Here is how to tell the ones that mean it from the ones that say it.' },
        { type: 'h2', text: 'Ask who actually writes the code' },
        { type: 'p', text: 'The single most important question: will the senior person in the sales call be on your project, or is that a closer who hands you off to juniors after signing? Ask to meet the actual engineers, ask their seniority, and ask whether staffing can change mid-project without your sign-off. Bait-and-switch staffing is the most common way good-looking agencies disappoint.' },
        { type: 'h2', text: 'Red flags that should slow you down' },
        { type: 'ul', items: [
          'A quote with no scope breakdown — a single number hides how they think.',
          'No willingness to start small (a paid discovery or a first milestone) before a big commitment.',
          'Portfolio screenshots but no case studies with real, measurable outcomes.',
          'Vague answers on code ownership, IP, source-control access and what you get if you leave.',
          'Pressure and urgency instead of questions about your business.',
        ] },
        { type: 'h2', text: 'Proof to ask for' },
        { type: 'p', text: 'Ask for a live project you can click, a reference you can call, and a sample of how they scope and communicate (a real proposal, a sprint plan, a status update). Ask how they handle security, testing and handover. Good agencies answer these instantly because they already work this way; weak ones improvise.' },
        { type: 'h2', text: 'Structure the risk out of it' },
        { type: 'p', text: 'The best protection is a small first commitment: a paid discovery or a tightly-scoped first milestone that proves the team before you bet the whole budget. If an agency resists starting small, that itself is the answer. We work exactly this way — start with a scoped estimate, prove it on a first milestone, expand on results.' },
      ],
    },
    es: {
      title: 'Cómo Evaluar una Agencia de Software Antes de Firmar',
      excerpt: 'Una web pulida no es evidencia. Las preguntas, las señales de alarma y las pruebas que separan a la agencia que entrega de la que solo vende.',
      body: [
        { type: 'p', text: 'Elegir una agencia de desarrollo es una decisión de alto riesgo y poca información: apuestas tu presupuesto y tu tiempo a un equipo que conoces desde hace dos llamadas. Toda agencia dice "ingenieros senior" y "entrega a tiempo". Así distingues a las que lo cumplen de las que solo lo dicen.' },
        { type: 'h2', text: 'Pregunta quién escribe el código de verdad' },
        { type: 'p', text: 'La pregunta más importante: ¿la persona senior de la llamada de ventas estará en tu proyecto, o es un cerrador que te pasa a juniors después de firmar? Pide conocer a los ingenieros reales, pregunta su seniority, y pregunta si la asignación puede cambiar a mitad de proyecto sin tu visto bueno. El cambio de equipo tipo "carnada" es la forma más común en que agencias vistosas decepcionan.' },
        { type: 'h2', text: 'Señales de alarma que deben frenarte' },
        { type: 'ul', items: [
          'Una cotización sin desglose de alcance — un número solo esconde cómo piensan.',
          'Nula disposición a empezar pequeño (un discovery pagado o un primer hito) antes de un compromiso grande.',
          'Capturas de portafolio pero ningún caso de éxito con resultados reales y medibles.',
          'Respuestas vagas sobre propiedad del código, IP, acceso al control de versiones y qué te llevas si te vas.',
          'Presión y urgencia en vez de preguntas sobre tu negocio.',
        ] },
        { type: 'h2', text: 'Pruebas que debes pedir' },
        { type: 'p', text: 'Pide un proyecto en vivo que puedas clickear, una referencia a la que puedas llamar, y una muestra de cómo acotan y comunican (una propuesta real, un plan de sprint, un reporte de estado). Pregunta cómo manejan seguridad, pruebas y entrega. Las buenas agencias responden al instante porque ya trabajan así; las débiles improvisan.' },
        { type: 'h2', text: 'Saca el riesgo de la ecuación con estructura' },
        { type: 'p', text: 'La mejor protección es un primer compromiso pequeño: un discovery pagado o un primer hito bien acotado que pruebe al equipo antes de apostar todo el presupuesto. Si una agencia se resiste a empezar pequeño, eso mismo es la respuesta. Nosotros trabajamos justo así — arrancas con una estimación acotada, la probamos en un primer hito, y expandimos según resultados.' },
      ],
    },
  },
  {
    ...
    en: {
      ...
      body: [
        { type: 'p', text: 'The term "software factory" (fábrica de software in Latin America) describes a team set up to deliver software as a repeatable, staffed service — not a one-off project. If you have heard it and were not sure whether it is marketing or a real model, here is the practical breakdown.' },
        { type: 'h2', text: 'What it actually is' },
        { type: 'p', text: 'A software factory provides engineering capacity you can turn up or down: developers, QA, design and delivery process, assembled into a team that plugs into your roadmap. Unlike a freelancer (one person, one skill) or a fixed-scope agency project (built, delivered, done), a factory is built for continuity — ongoing delivery, staff you can scale, and a process that survives any single person leaving.' },
        { type: 'h2', text: 'When it fits' },
        { type: 'ul', items: [
          'You have more roadmap than your current team can ship, and you need capacity fast.',
          'You want a dedicated team, not a rotating cast, but not the cost of full-time in-house hires.',
          'Your work is ongoing (a live product with a backlog), not a single fixed deliverable.',
          'You value a defined process — sprints, code review, QA — over the lowest possible hourly rate.',
        ] },
        { type: 'h2', text: 'When it does not' },
        { type: 'p', text: 'If you need one small, well-defined thing built once, a freelancer or a fixed-scope project is cheaper and simpler. A factory earns its keep on continuity and scale, not on one-off tasks. And "factory" should never mean assembly-line juniors churning tickets — the value is in senior judgment and a process that protects quality, not raw headcount.' },
        { type: 'h2', text: 'The nearshore factory advantage' },
        { type: 'p', text: 'For US and Canadian companies, a Latin American software factory combines the two things that matter: a dedicated, scalable team AND real timezone overlap at 40-60% below local cost. You get the continuity of an in-house team, the flexibility of contractors, and same-workday collaboration. That is the model we run — a senior-led, nearshore team you can scale to your roadmap. Price a team for your product with our estimator.' },
      ],
    },
    es: {
      title: 'Qué Es una Fábrica de Software — y Cuándo Contratar Una',
      excerpt: 'El modelo de "fábrica de software" promete equipos a demanda. Qué significa de verdad, dónde entrega, y en qué se diferencia de una agencia o un freelancer.',
      body: [
        { type: 'p', text: 'El término "fábrica de software" describe un equipo montado para entregar software como un servicio repetible y con personal — no un proyecto suelto. Si lo has escuchado y no sabías si es marketing o un modelo real, aquí está el desglose práctico.' },
        { type: 'h2', text: 'Qué es en realidad' },
        { type: 'p', text: 'Una fábrica de software provee capacidad de ingeniería que subes o bajas: developers, QA, diseño y proceso de entrega, armados en un equipo que se enchufa a tu roadmap. A diferencia de un freelancer (una persona, una habilidad) o un proyecto de agencia de alcance fijo (se construye, se entrega, termina), una fábrica está hecha para continuidad — entrega continua, personal que puedes escalar, y un proceso que sobrevive si cualquier persona se va.' },
        { type: 'h2', text: 'Cuándo encaja' },
        { type: 'ul', items: [
          'Tienes más roadmap del que tu equipo actual puede entregar, y necesitas capacidad rápido.',
          'Quieres un equipo dedicado, no un elenco rotativo, pero sin el costo de contrataciones internas full-time.',
          'Tu trabajo es continuo (un producto vivo con backlog), no un único entregable fijo.',
          'Valoras un proceso definido — sprints, code review, QA — por encima de la tarifa por hora más baja posible.',
        ] },
        { type: 'h2', text: 'Cuándo no' },
        { type: 'p', text: 'Si necesitas una sola cosa pequeña y bien definida construida una vez, un freelancer o un proyecto de alcance fijo es más barato y simple. Una fábrica se paga por continuidad y escala, no por tareas sueltas. Y "fábrica" nunca debería significar juniors en línea de ensamblaje despachando tickets — el valor está en el criterio senior y un proceso que protege la calidad, no en el headcount crudo.' },
        { type: 'h2', text: 'La ventaja de la fábrica nearshore' },
        { type: 'p', text: 'Para empresas de USA y Canadá, una fábrica de software latinoamericana combina las dos cosas que importan: un equipo dedicado y escalable Y solape horario real a 40-60% por debajo del costo local. Obtienes la continuidad de un equipo interno, la flexibilidad de contratistas, y colaboración en la misma jornada. Ese es el modelo que operamos — un equipo nearshore liderado por seniors que puedes escalar a tu roadmap. Cotiza un equipo para tu producto con nuestro estimador.' },
      ],
    },
  },
  {
